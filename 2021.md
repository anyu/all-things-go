...
## Backlog
Keep a min of 3 things here; cap at 10.

- Deleting from a map[interface]interface{}
- Different ways of map instantiation and how to choose
- Experiment with go delve